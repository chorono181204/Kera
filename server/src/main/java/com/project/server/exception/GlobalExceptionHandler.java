...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleJwtException(org.springframework.security.oauth2.jwt.JwtException ex) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Token invalid: " + ex.getMessage());
    }
